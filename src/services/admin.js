...
//         return axiosInstance.post(`${baseUrl}/api-admin/management/add-admin`, data);
//     };
//     const getAllAdmin = () => {
//         return axiosInstance.get(`${baseUrl}/api-admin/management/all-admin`);
//     };
...
//     return {postAdmin,patchActivityAdmin, getAllAdmin, getSingleAdmin,updateAdmin,  getDeleteAdmin, getTopicsPaginated }
// }
